...
% Skip rounding for thin slabs (<15um): rounding 10.24->20 breaks phzA size in genCorticalLightPathLite
if vol_params.vol_sz(3) >= 15 && mod(vol_params.vol_sz(3),10)~=0
