...
fprintf('Ideal:')
fprintf('Number components: %d\n', size(est.estact,1))
fprintf('Number paired components (>0.1,>0.3,>0.5): (%d,%d,%d)\n', sum(est.corrvals>0.1),sum(est.corrvals>0.3),sum(est.corrvals>0.5))
fprintf('Number unique components found (>0.1,>0.3,>0.5): (%d,%d,%d)\n', ...
...
fprintf('Number doubled components (>0.1,>0.3,>0.5): (%d,%d,%d)\n', ...
